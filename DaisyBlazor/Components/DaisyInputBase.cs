...
{
    public abstract class DaisyInputBase<TValue> : DaisyComponentBase, IDisposable
    {
        ...
        private void UpdateAdditionalValidationAttributes()
        {
            ...
            if (EditContext.GetValidationMessages(FieldIdentifier).Any())
            {
                ...
                if (DaisyInputBase<TValue>.ConvertToDictionary(AdditionalAttributes, out var additionalAttributes))
                {
